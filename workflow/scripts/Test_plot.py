...
df_long = df_long[df_long["End use"] != "Total Residential"]
...
output_path = output_dir_data + 'output_EI_vs_energy_comp.csv'
df_long.to_csv(output_path, index=False)
...
filtered_df = filtered_df[filtered_df['sub2sectors'] == '16_01_02_residential']
...
output_dir = variable_path + '/plots/IEA vs APERC Energy/absolute values same plot'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
